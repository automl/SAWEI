...
from target_algorithms.registration import (
    TargetAlgorithms,
...
class COCOTargetAlgorithm(AbstractTargetAlgorithm):
    ...
    def __init__(self, coco_problem):  # this is an ioh problem instance now
        ...
        lower_bounds = self.coco_problem.bounds.lb  # self.coco_problem.lower_bounds
        upper_bounds = self.coco_problem.bounds.ub  # self.coco_problem.upper_bounds
